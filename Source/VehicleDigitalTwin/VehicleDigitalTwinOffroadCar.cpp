...
#include "VehicleDigitalTwinOffroadCar.h"
#include "VehicleDigitalTwinOffroadWheelFront.h"
#include "VehicleDigitalTwinOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AVehicleDigitalTwinOffroadCar::AVehicleDigitalTwinOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleDigitalTwinOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleDigitalTwinOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleDigitalTwinOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleDigitalTwinOffroadWheelRear::StaticClass();
