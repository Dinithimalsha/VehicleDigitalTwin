...
#include "VehicleDigitalTwinOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class VEHICLEDIGITALTWIN_API AVehicleDigitalTwinOffroadCar : public AVehicleDigitalTwinPawn
{
	GENERATED_BODY()
