...
#include "VehicleDigitalTwinSportsCar.h"
#include "VehicleDigitalTwinSportsWheelFront.h"
#include "VehicleDigitalTwinSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AVehicleDigitalTwinSportsCar::AVehicleDigitalTwinSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleDigitalTwinSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleDigitalTwinSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleDigitalTwinSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleDigitalTwinSportsWheelRear::StaticClass();
